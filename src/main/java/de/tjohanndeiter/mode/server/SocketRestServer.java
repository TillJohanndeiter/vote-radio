 ...
 */
class SocketRestServer extends NanoWSD implements RestServer, PropertyChangeListener {
     ...
     */
    SocketRestServer(final int port, final SessionHandler sessionHandler,
